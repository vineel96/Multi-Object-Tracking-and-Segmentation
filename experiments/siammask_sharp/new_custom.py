...
class Custom(SiamMask):
    ...
    def track_mask(self, search=None, lists=None):
        ...
        for target in lists:
            self.feature, self.search = self.features.forward_all(target["x_crop"].cuda())
            ...
            # result_dict["rpn_pred_loc"] = rpn_pred_loc
            # result_dict["rpn_pred_mask"] = pred_mask
            result.append({"rpn_pred_cls": rpn_pred_cls, "rpn_pred_loc": rpn_pred_loc, "rpn_pred_mask": pred_mask})
